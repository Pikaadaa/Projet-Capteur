...
<div class="d-flex ml-auto mr-auto mt-5 card " style="width: 20rem;">
    @if ($employee->image)
      <img src="{{ asset('storage/'. $employee->image) }}" class="card-img-top" alt="Photo profil" >
    @else
      <img src="/storage/picture/765-default-avatar.png" class="card-img-top" alt="Photo de profil par Défault" >
    @endif
    <div class="card-body">
