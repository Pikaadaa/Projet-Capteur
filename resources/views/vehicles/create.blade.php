...
<form method="POST" action="{{ route('vehicles.store') }}">
    ...
    <div>
        ...
        <div class="date_of_manufacture mb-2">
            ...
            <input class="form-control @if($errors->has('date_of_manufacture')) is-invalid" @endif type="date" name="date_of_manufacture" id="date_of_manufacture" value="{{ old('date_of_manufacture') }}" required >
